...
const dict = {
  ...
  zh: {
    ...
    home_sandbox: '自由实验',
    home_practice_title: '巧算练习区',
    home_practice_desc: '自动出题，按用时给评价。先看结构，再下手。',
    home_practice_badge: '已开放 {0} 套练习',
    ...
    practice_back: '← 回首页',
    practice_timer: '用时 {0}',
    practice_timer_idle: '先选练习',
    practice_total_coins: '硬币罐 {0} 硬币',
    practice_lobby_title: '选择练习套组',
    practice_lobby_subtitle: '每局 {0} 题，做完整局后硬币才会倒进硬币罐。',
    practice_lobby_rule_title: '做完整局才收进硬币罐',
    practice_lobby_rule_body: '先选一个套组开始。计时、题目分值和本局小袋硬币都会在进入后开始；中途离开，小袋子会清空。',
    practice_best: '最佳用时',
  ...
  ja: {
    ...
    home_sandbox: '自由実験',
    home_practice_title: 'くふう計算トレーニング',
    home_practice_desc: '自動で問題を作り、時間に応じて評価します。',
    home_practice_badge: '{0} セット公開中',
    ...
    practice_back: '← ホームへ',
    practice_timer: '時間 {0}',
    practice_timer_idle: 'セットを選ぼう',
    practice_total_coins: 'コインびん {0} コイン',
    practice_lobby_title: '練習セットを選ぶ',
    practice_lobby_subtitle: '1 セット {0} 問。最後まで終えるとコインびんに入ります。',
    practice_lobby_rule_title: '最後までやるとコインびんへ',
    practice_lobby_rule_body: 'セットを選ぶと時間と問題が始まります。このセットのコインは小さなふくろに入り、途中でやめるとふくろは空になります。',
  ...
  en: {
    ...
    home_practice_title: 'Smart Calc Practice',
    home_practice_desc: 'Auto-generated regrouping drills with time-based feedback.',
    home_practice_badge: '{0} decks available',
    ...
    practice_timer_idle: 'Choose a deck',
    practice_total_coins: '{0} coins in the jar',
    practice_lobby_title: 'Choose a Practice Deck',
    practice_lobby_subtitle: '{0} problems per session. Coins go into the jar only after the full session.',
    practice_lobby_rule_title: 'Finish a session to fill the jar',
    practice_lobby_rule_body: 'Choose a deck to start the timer, scoring, and this session’s coin pouch. If you leave early, the pouch is emptied.',
