...
export function initLocale() {
  ...
  if (typeof document !== 'undefined') {
    document.documentElement.lang =
      _locale === 'ja' ? 'ja' : _locale === 'en' ? 'en' : 'zh-CN';
  }
}
...
const dict = {
  ...
  zh: {
    ...
    play_track:   '实验线',
    back_home:    '← 回首页',
    home_side_title: '练习与实验',
    home_side_desc: '计算练习会按套组扩展，主线仍专注等式与建模。',
    home_sandbox: '自由实验',
    home_practice_title: '算数基础能力训练区',
    home_practice_desc: '专项训练数感、乘法结构、因数倍数和应用题底层能力。',
    home_practice_badge: '已开放 {0} 个能力域',
    home_sandbox_desc: '自己改式子、乱试路线，看看等式怎样保持平衡。',
    home_tip_title: '小贴士',
    home_tip_desc: '每个关卡开始前，先想一想题目在问什么，再动手。',
    journey_prog: '{0}/{1}',
    ...
    practice_back: '← 回首页',
    practice_timer: '用时 {0}',
    practice_timer_idle: '先选能力',
    practice_timer_learning: '观察练习',
    practice_total_coins: '硬币罐 {0} 硬币',
    practice_lobby_title: '算数基础能力训练区',
    practice_lobby_subtitle: '先选能力域，再选专项和训练阶段。小训练每局 {0} 题。',
    practice_lobby_rule_title: '先找感觉，再做训练',
    practice_lobby_rule_body: '找感觉和说关系不计时、不结算硬币；小训练和混合挑战完成整局后，硬币才会倒进硬币罐。',
    practice_breadcrumb_domains: '能力域',
    practice_domain_meta: '{0} 个专项',
    practice_open_domain: '进入能力域',
    practice_module_meta: '已完成 {0}/{1} 阶段',
    practice_open_module: '选择阶段',
    practice_stage_done: '最佳 {0} · {1} 硬币',
    practice_stage_done_short: '已完成',
    practice_stage_new: '还没完成',
    practice_best: '最佳用时',
    practice_last_rating: '上次评价',
    practice_none: '还没有',
    practice_paper_note: '可以先在脑中想，也可以先在草稿纸上拆一拆、配一配，再把答案填进来。',
    practice_question_label: '本题',
    practice_points: '第 {1}/{2} 题 · 本题 {0} 硬币',
    practice_points_earned: '获得 {0} 硬币',
    practice_card_new: '还没完成过这一组',
    practice_card_best: '最佳 {0}',
    practice_card_last_coins: '上次 {0} 硬币',
    practice_start_session: '开始 {0} 题',
    practice_start_learning: '观察 {0} 题',
    practice_session_rule: '本局进度：{0}/{1} · 小袋 {2} 硬币，做完整局后倒进硬币罐',
    practice_session_rule_learning: '观察进度：{0}/{1} · 不计时，不结算硬币',
    practice_learning_points: '第 {0}/{1} 题 · 找结构',
    practice_question_bank_pending: '答对了，{0} 硬币先放进小袋子。本局小袋里已有 {1} 硬币，做完整局才会倒进硬币罐。',
    practice_question_learning_done: '找对了。这一阶段只练观察，不把硬币放进小袋。',
    practice_session_complete_text: '本局用时 {0} · 本局获得 {1} 硬币 · 硬币罐现在有 {2} 硬币',
    practice_learning_complete_text: '完成 {0} 题观察练习。现在可以进入小训练，把感觉变成速度。',
    practice_correct_reward: '+{0} 小袋硬币',
    practice_correct_learning_reward: '找对结构',
    practice_complete_reward_title: '一局完成！',
    practice_complete_reward: '+{0} 硬币进硬币罐',
    practice_back_to_lobby: '回到套组入口',
    practice_hint_summary: '给一点提示',
    practice_answer_label: '答案',
    practice_answer_placeholder: '填入最后答案',
    practice_submit: '提交答案',
    practice_next_problem: '换一题',
    practice_retry_title: '再看一眼结构',
    practice_retry_wrong: '答案还不对。先别急着硬算，先看看有没有能凑整、能配对、能提出来的部分。',
    practice_retry_invalid: '这里只接受整数答案。',
    practice_retry_empty: '先填一个答案再提交。',
    practice_retry_choice_empty: '先选一个选项再提交。',
    practice_choice_label: '先选出你看到的结构',
    practice_strategy_label: '解题思路',
    practice_time_used: '本次用时：{0}',
    practice_new_best: '刷新了这一组练习的最佳速度。',
    load_custom:  '载入自定义等式',
    random_btn:   '随机来一题',
    theme_toggle: '切换主题',
  ...
  ja: {
    ...
    play_track:   '実験モード',
    back_home:    '← ホームへ',
    home_side_title: '練習と実験',
    home_side_desc: '計算練習はセットごとに増やし、本編は等式と文章題に集中します。',
    home_sandbox: '自由実験',
    home_practice_title: '算数の基礎トレーニング',
    home_practice_desc: '数の感じ、かけ算の形、約数・倍数、文章題の土台を練習します。',
    home_practice_badge: '{0} つの力を公開中',
    home_sandbox_desc: '式を自由に動かして、等式のバランスを試そう。',
    home_tip_title: 'ヒント',
    home_tip_desc: '各ステージの前に、何を聞かれているかを考えてから動かそう。',
    journey_prog: '{0}/{1}',
    ...
    practice_back: '← ホームへ',
    practice_timer: '時間 {0}',
    practice_timer_idle: '力を選ぼう',
    practice_timer_learning: '見る練習',
    practice_total_coins: 'コインびん {0} コイン',
    practice_lobby_title: '算数の基礎トレーニング',
    practice_lobby_subtitle: '力を選びます。次に練習メニューと段階を選びます。小トレーニングは {0} 問です。',
    practice_lobby_rule_title: '先に形を見る。あとで練習する',
    practice_lobby_rule_body: '「感じをつかむ」「関係を言う」は時間もコインもありません。小トレーニングとミックス挑戦は、最後までやるとコインがびんに入ります。',
    practice_breadcrumb_domains: '力の地図',
    practice_domain_meta: '{0} メニュー',
    practice_open_domain: 'この力を開く',
    practice_module_meta: '{0}/{1} 段階が完了',
    practice_open_module: '段階を選ぶ',
    practice_stage_done: 'ベスト {0} · {1} コイン',
    practice_stage_done_short: '完了',
    practice_stage_new: 'まだです',
    practice_best: 'ベストタイム',
    practice_last_rating: '前回の評価',
    practice_none: 'まだありません',
    practice_paper_note: '頭の中で考えても、紙に書いても大丈夫。まとまりを見つけてから答えを書こう。',
    practice_question_label: 'この問題',
    practice_points: '{1}/{2} 問目 · この問題 {0} コイン',
    practice_points_earned: '{0} コイン獲得',
    practice_card_new: 'まだ完了していません',
    practice_card_best: 'ベスト {0}',
    practice_card_last_coins: '前回 {0} コイン',
    practice_start_session: '{0} 問スタート',
    practice_start_learning: '{0} 問見る',
    practice_session_rule: '進み具合：{0}/{1} · ふくろ {2} コイン。最後まで終えるとコインびんへ',
    practice_session_rule_learning: '見る練習：{0}/{1}。時間もコインもありません',
    practice_learning_points: '{0}/{1} 問目 · 形を見る',
    practice_question_bank_pending: '正解。{0} コインを小さなふくろに入れました。今は {1} コイン、最後までやるとコインびんに入ります。',
    practice_question_learning_done: '正解。ここでは形を見る練習だけをします。コインは入りません。',
    practice_session_complete_text: 'セット時間 {0} · 今回 {1} コイン · コインびんは {2} コイン',
    practice_learning_complete_text: '{0} 問の見る練習が終わりました。次は小トレーニングで速さにつなげよう。',
    practice_correct_reward: '+{0} ふくろコイン',
    practice_correct_learning_reward: '形を見つけた',
    practice_complete_reward_title: 'セット完了！',
    practice_complete_reward: '+{0} コインがびんへ',
    practice_back_to_lobby: 'セット入口へ',
    practice_hint_summary: 'ヒントを見る',
    practice_answer_label: '答え',
    practice_answer_placeholder: '最後の答えを入力',
    practice_submit: '答え合わせ',
    practice_next_problem: '別の問題へ',
    practice_retry_title: '式の形をもう一度',
    practice_retry_wrong: 'まだ違います。計算を進める前に、きりのよい組や共通の因数がないか見てみましょう。',
    practice_retry_invalid: 'ここには整数だけを入力してください。',
    practice_retry_empty: '先に答えを入れてください。',
    practice_retry_choice_empty: '先に選んでください。',
    practice_choice_label: '見えた形を選ぼう',
    practice_strategy_label: '考え方',
    practice_time_used: '今回の時間: {0}',
    practice_new_best: 'この練習のベストタイムを更新しました。',
    ...
    build_done_t:    '式が正しいよ！',
    build_done_m:    'お話を式にできたね。',
    build_coach_t:   '式づくりヒント',
  ...
  en: {
    ...
    play_track:   'Sandbox',
    back_home:    '← Home',
    home_side_title: 'Practice & Play',
    home_side_desc: 'Calculation drills will grow as decks, while the main quest stays focused on equations.',
    home_sandbox: 'Free Play',
    home_practice_title: 'Arithmetic Foundations',
    home_practice_desc: 'Focused practice for number sense, multiplication structure, factors, multiples, and word-problem foundations.',
    home_practice_badge: '{0} skill domains available',
    home_sandbox_desc: 'Change equations freely and experiment with balancing moves.',
    home_tip_title: 'Quick Tip',
    home_tip_desc: 'Before moving cards, pause and ask what the problem is really asking.',
    journey_prog: '{0}/{1}',
    journey_complete: '🎉 Journey complete!',
    continue_journey: 'Continue',
    start_journey: 'Start adventure',
    practice_back: '← Home',
    practice_timer: 'Time {0}',
    practice_timer_idle: 'Choose a skill',
    practice_timer_learning: 'Learning round',
    practice_total_coins: '{0} coins in the jar',
    practice_lobby_title: 'Arithmetic Foundations',
    practice_lobby_subtitle: 'Choose a skill domain, then a module and stage. Focused practice uses {0} problems per session.',
    practice_lobby_rule_title: 'Feel the structure before drilling',
    practice_lobby_rule_body: 'Pattern and relationship stages have no timer or coins. Focused practice and mixed challenge bank coins only after the full session.',
    practice_breadcrumb_domains: 'Skill Domains',
    practice_domain_meta: '{0} modules',
    practice_open_domain: 'Open domain',
    practice_module_meta: '{0}/{1} stages done',
    practice_open_module: 'Choose stage',
    practice_stage_done: 'Best {0} · {1} coins',
    practice_stage_done_short: 'Completed',
    practice_stage_new: 'Not completed',
    practice_best: 'Best Time',
    practice_last_rating: 'Last Rating',
    practice_none: 'None yet',
    practice_paper_note: 'Think it through mentally or sketch it on paper first, then enter the final answer.',
    practice_question_label: 'Problem',
    practice_points: 'Problem {1}/{2} · {0} coins',
    practice_points_earned: '{0} coins earned',
    practice_card_new: 'No completed session yet',
    practice_card_best: 'Best {0}',
    practice_card_last_coins: 'Last {0} coins',
    practice_start_session: 'Start {0} problems',
    practice_start_learning: 'Observe {0} problems',
    practice_session_rule: 'Session progress: {0}/{1} · {2} coins in the pouch until the session is complete',
    practice_session_rule_learning: 'Learning progress: {0}/{1} · no timer, no coins',
    practice_learning_points: 'Problem {0}/{1} · spot the structure',
    practice_question_bank_pending: 'Correct. {0} coins went into the pouch. The pouch has {1} coins; finish the session to pour them into the jar.',
    practice_question_learning_done: 'Correct. This stage trains observation only, so no coins go into the pouch.',
    practice_session_complete_text: 'Session time {0} · earned {1} coins · jar now has {2} coins',
    practice_learning_complete_text: 'Finished {0} observation problems. Next, use focused practice to turn the pattern into fluency.',
    practice_correct_reward: '+{0} pouch coins',
    practice_correct_learning_reward: 'Structure spotted',
    practice_complete_reward_title: 'Session Complete!',
    practice_complete_reward: '+{0} coins into the jar',
    practice_back_to_lobby: 'Back to deck lobby',
    practice_hint_summary: 'Show a hint',
    practice_answer_label: 'Answer',
    practice_answer_placeholder: 'Enter the final answer',
    practice_submit: 'Check Answer',
    practice_next_problem: 'New Problem',
    practice_retry_title: 'Look at the structure again',
    practice_retry_wrong: 'That answer is not correct yet. Look for a round-number pair or a common factor before grinding through it.',
    practice_retry_invalid: 'This practice currently accepts integer answers only.',
    practice_retry_empty: 'Enter an answer first.',
    practice_retry_choice_empty: 'Choose an option first.',
    practice_choice_label: 'Choose the structure you see',
    practice_strategy_label: 'Strategy',
    practice_time_used: 'Time used: {0}',
    practice_new_best: 'New best time for this deck.',
